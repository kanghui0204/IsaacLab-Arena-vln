...
def main():
    ...
    #     hand_control_device="leapmotion",
    ...
    with SimulationAppContext(args_cli):
        ...
        for _ in tqdm.tqdm(range(num_steps)):
            with torch.inference_mode():
                upperbody_action = device_streamer.get_leapmotion_action()
                action = torch.cat([upperbody_action, navigate_cmd, base_height_cmd, torso_orientation_rpy_cmd])
