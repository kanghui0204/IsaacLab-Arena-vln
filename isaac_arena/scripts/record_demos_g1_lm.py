...
def run_simulation_loop(
    ...
    keyboard_interface.add_callback("E", decrease_angular_vel)
    keyboard_interface.add_callback("A", increase_linear_vel_y)
    keyboard_interface.add_callback("D", decrease_linear_vel_y)
    keyboard_interface.add_callback("Z", increase_base_height)
    keyboard_interface.add_callback("X", decrease_base_height)
    keyboard_interface.add_callback("G", increase_torso_orientation_roll)
    keyboard_interface.add_callback("J", decrease_torso_orientation_roll)
    keyboard_interface.add_callback("Y", increase_torso_orientation_pitch)
    keyboard_interface.add_callback("H", decrease_torso_orientation_pitch)
    keyboard_interface.add_callback("T", increase_torso_orientation_yaw)
    keyboard_interface.add_callback("U", decrease_torso_orientation_yaw)
    # keyboard_interface.add_callback("T", toggle_standing) # disable for homie
