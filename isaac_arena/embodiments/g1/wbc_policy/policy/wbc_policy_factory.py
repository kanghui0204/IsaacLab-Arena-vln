...
from isaac_arena.embodiments.g1.wbc_policy.policy.g1_homie_policy import G1HomiePolicy, G1HomiePolicyV2
...
def get_wbc_policy(
    ...
    if robot_type == "g1":
        upper_body_policy_type = wbc_config.get("upper_body_policy_type", "identity")
