...
class SequentialKitchenPickAndPlaceEnvironment(ExampleEnvironmentBase):

    name: str = "sequential_kitchen_pick_and_place"
    ...
    def get_env(self, args_cli: argparse.Namespace):  # -> IsaacLabArenaEnvironment:
        ...
        from isaaclab_arena.tasks.test_pick_and_place_task import TestPickAndPlaceTask
        from isaaclab_arena.utils.pose import Pose

        from isaaclab_arena.tasks.sequential_pick_and_place_task import SequentialPickAndPlaceTask
        ...
        destination_location = ObjectReference(
            ...
            prim_path="{ENV_REGEX_NS}/kitchen/Cabinet_B_01",
