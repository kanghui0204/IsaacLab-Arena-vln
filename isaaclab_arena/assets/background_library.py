...
class KitchenBackground(LibraryBackground):
    ...
    name = "kitchen"
    tags = ["background"]
    usd_path = "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/kitchen_scene_teleop_v3.usd"
...
class PackingTableBackground(LibraryBackground):
    ...
    name = "packing_table"
    tags = ["background"]
    usd_path = "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/packing_table.usd"
...
class GalileoBackground(LibraryBackground):
    ...
    name = "galileo"
    tags = ["background"]
    usd_path = "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/galileo_simplified.usd"
...
class GalileoLocomanipBackground(LibraryBackground):
    ...
    usd_path = (
        "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/g1_locomanip_assets/galileo_locomanip.usd"
    )
    initial_pose = Pose(position_xyz=(4.420, 1.408, -0.795), rotation_wxyz=(1.0, 0.0, 0.0, 0.0))
    object_min_z = -0.2
