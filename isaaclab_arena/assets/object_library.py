...
class PowerDrill(LibraryObject):
    ...
    name = "power_drill"
    tags = ["object"]
    usd_path = "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/power_drill_physics.usd"
...
class BrownBox(LibraryObject):
    ...
    name = "brown_box"
    tags = ["object"]
    usd_path = "omniverse://isaac-dev.ov.nvidia.com/Projects/nvblox/isaaclab_arena/g1_locomanip_assets/brown_box.usd"
