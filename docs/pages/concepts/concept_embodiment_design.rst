...
Embodiments provide complete robot definitions that integrate with IsaacLab Arena's environment composition system while maintaining robot-specific behaviors.
